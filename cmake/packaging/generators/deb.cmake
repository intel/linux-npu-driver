...
list(APPEND SHLIBDEPS_PRIVATE_DIRS ${LevelZero_LIBRARY_DIRS})
set(CPACK_DEBIAN_PACKAGE_SHLIBDEPS_PRIVATE_DIRS ${SHLIBDEPS_PRIVATE_DIRS})

# Component conflicts
set(CPACK_DEBIAN_LEVEL-ZERO_PACKAGE_CONFLICTS "level-zero, level-zero-devel, libze1, libze-dev")

# Set package name
set(CPACK_DEBIAN_PACKAGE_VERSION "${CPACK_PACKAGE_VERSION}~${LINUX_SYSTEM_NAME}${LINUX_SYSTEM_VERSION_ID}")
